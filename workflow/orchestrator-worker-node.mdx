---
title: "Orchestrator-Worker Node on MindPal"
---

The Orchestrator-Worker Node is a feature in MindPal multi-agent workflow that enables you to break down complex tasks into smaller, manageable subtasks. This node is well-suited for tasks where the subtasks needed cannot be predicted in advance, such as coding or research tasks that involve gathering and analyzing information from multiple sources.
