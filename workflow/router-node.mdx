---
title: "Router Node on MindPal Multi-Agent Workflow"
---

The Router Node is a component in MindPal Multi-Agent Workflow that enables you to classify an input and direct it to a specialized follow-up agent. This node allows for separation of concerns, making it easier to build more specialized workflows that cater to specific needs.
